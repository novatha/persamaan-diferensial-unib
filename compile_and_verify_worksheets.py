...
for w in weeks:
    tex = f"worksheet{w}.tex"
    pdf = f"worksheet{w}.pdf"
    log = f"worksheet{w}.log"
...
print("-" * 65)
if all_passed:
    print("ALL 14 WORKSHEETS PASSED VERIFICATION WITH ZERO OVERFULLS AND EXACTLY 2 PAGES!")
else:
    print("SOME WORKSHEETS NEED ADJUSTMENT.")
