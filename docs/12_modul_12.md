# Catatan Kuliah Persamaan Diferensial - Minggu 12: Persamaan Panas 1D (Difusi Termal pada Kabel)
...
**Kondisi Batas (Dirichlet):** Kabel dijaga pada suhu 0 di kedua ujungnya:
$u(0,t) = 0$ dan $u(L,t) = 0$ untuk $t > 0$.

**Kondisi Awal:** Suhu awal kabel pada $t=0$ adalah $f(x)$:
$u(x,0) = f(x)$.
