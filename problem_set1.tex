...
\lfoot{\footnotesize\color{gray}Problem Set OBE \textbar\ \textbf{Video}: \url{https://youtu.be/Zq6IbzuVLBw} \textbar\ \href{https://www.youtube.com/playlist?list=PLS5oOZWXZeTw}{\color{unibblue}\textbf{Playlist}}}
...
\noindent\begin{minipage}[c]{0.68\textwidth}%
  ...
  {\small\textbf{Topik Minggu 1:} Klasifikasi PDB/PDP, Nilai Awal (IVP), \& Pemodelan RL}%
\end{minipage}%
\hfill%
...
\begin{tcolorbox}[colback=boxbg,colframe=unibgold!90!black,boxrule=0.6pt,arc=2pt,left=5pt,right=5pt,top=3pt,bottom=3pt,title=\textbf{\scriptsize Capaian Pembelajaran (Sub-CPMK 1) \& Pedoman Pengerjaan Tugas}]
  \scriptsize
  ...
  \textbf{Video Perkuliahan (YouTube):} \url{https://youtu.be/Zq6IbzuVLBw} \hfill \textbf{Playlist:} \href{https://www.youtube.com/playlist?list=PLS5oOZWXZeTw}{\color{unibblue}\textbf{bit.ly/pd-unib-playlist}}\\\textbf{Ketentuan Tugas:} Kerjakan secara mandiri pada kertas folio/A4 bergaris atau laporan digital rapi. Lampirkan penurunan rumus analitis lengkap dan cetak visualisasi kode program Julia (Soal C6). Kumpulkan pada awal perkuliahan minggu berikutnya.
\end{tcolorbox}
...
{\footnotesize Tuliskan definisi lengkap Persamaan Diferensial Biasa (PDB) linier orde 1 beserta bentuk kanonikalnya $\frac{dy}{dt} + P(t)y = Q(t)$. Berikan satu contoh nyata fenomena kelistrikan yang direpresentasikan oleh bentuk tersebut.}\par

\vspace{2.5mm}

% Soal C2
\noindent\textbf{2. (C2 - Memahami \textbar\ Bobot: 15 Poin)}\par\vspace{0.8mm}
{\footnotesize Jelaskan perbedaan mendasar antara 'Solusi Umum' dan 'Solusi Khusus' pada penyelesaian suatu Masalah Nilai Awal (IVP). Jelaskan mengapa hukum kontinuitas fluks magnetik induktor mensyaratkan arus tidak boleh melompat seketika ($i(0^-) = i(0^+)$).}\par
