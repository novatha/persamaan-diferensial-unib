...
def main():
    with sync_playwright() as p:
        ...
        # Upload ke Minggu ke-5
        filepath = "/Users/novaliodaratha/Documents/2026/mengajar/Persamaan Diferensial/Simulasi_Transien_RLC.ipynb"
        upload_file(page, 5, filepath, "Simulasi Interaktif RLC (Jupyter Notebook)", "Silakan unduh file ini dan jalankan di Google Colab untuk simulasi interaktif.")
        
        print("\nNOTEBOOK BERHASIL DIUNGGAH!")
        time.sleep(2)
        browser.close()
